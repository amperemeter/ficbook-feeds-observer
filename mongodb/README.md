...
2. Создать папку проекта и разместить внутри нее файлы [index.js](mongodb/index.js) и [package.json](mongodb/package.json) из папки mongodb. Переименовать `index.js` и `package-mongodb.json` в `index.js` и `package.json` соответственно.
