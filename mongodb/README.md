...
2. Создать папку проекта и разместить внутри нее файлы [index.js](index.js) и [package.json](package.json) из папки mongodb. Переименовать `index.js` и `package-mongodb.json` в `index.js` и `package.json` соответственно.
